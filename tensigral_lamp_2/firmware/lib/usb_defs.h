...
#define BTABLE_BASE 0x40006000
//#define CONTROL_OUT_PMA_ADDRESS 0x18     //!< Packet Memory Address of the control OUT endpoint
//#define CONTROL_IN_PMA_ADDRESS  0x58     //!< Packet Memory Address of the control IN endpoint
#define CONTROL_MAX_PACKET_SIZE 0x40     //!< Maximum control packet size
#define IN_ENDPOINT_ADDRESS 0x81         //!< Address of the IN endpoint
#define OUT_ENDPOINT_ADDRESS 0x02
//#define IN_ENDPOINT_PMA_ADDRESS 0x98     //!< Packet Memory Address of the IN endpoint
//#define OUT_ENDPOINT_ADDRESS 0x1         //!< Address of the OUT endpoint
//#define OUT_ENDPOINT_PMA_ADDRESS = 0xD8 //!< Packet Memory Address of the OUT endpoint

#define GET_PMA( epno, isrx )  ( 0x18 + (epno) * 128 + (isrx) * 64 )

#define USB_EST_IDLE	0
#define USB_EST_SETUP	1
#define USB_EST_DATA_IN	2
#define USB_EST_DATA_OUT	3
#define USB_EST_STATUS_IN	4
#define USB_EST_STATUS_OUT	5
#define USB_EST_STALL	6


#define USB_DS_NONE    0
#define USB_DS_DEFAULT 1
#define USB_DS_ADDRESSED  2
#define USB_DS_CONFIGURED 3
#define USB_DS_SUSPENDED  4
...
//The original function, setRxCount looks like it was wrong.  This is a re-written version of it.

void UBsetRxCount(volatile struct UsbBufferDescriptionTableEntry * e, int length);


struct EndpointBufferDescription {
	struct UsbBufferDescriptionTableEntry tx;
	struct UsbBufferDescriptionTableEntry rx;
} __attribute__((packed));
